...
/// Parse the [input] CSS style sheet into a tree. The [input] can be a [String],
...
class _Parser {
  ...
  /// Returns a VarDefinitionDirective or VarDefinition if a variable otherwise
  ...
  SimpleSelectorSequence? simpleSelectorSequence(bool forceCombinatorNone) {
    ...
    if (simpleSel == null &&
      ...
      //    .foo &          combinator before & is DESCENDANT
